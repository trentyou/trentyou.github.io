...
Instead of updating my progress in this post, I'm going to do something different by teaching one of the features I recently implemented in my app. Today I'm going to show you how to implement a shake animation to demonstrate a negative response to user input for iOS 8 (also works for iOS 7 and iOS 6). 
